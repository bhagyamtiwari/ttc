    ...
    <section className="bg-red text-paper">
      <div className="shell grid gap-8 py-14 md:py-16 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end lg:gap-16">
        <Rise className="max-w-[44rem]">
          <h2 className="display text-[clamp(2rem,7vw,2.7rem)] uppercase md:text-[clamp(2.4rem,4.2vw,3.2rem)]">
        ...
        <Rise delay={80}>
          <a
            ...
            {...waLinkProps}
            className="inline-flex w-full items-center justify-center gap-2.5 bg-paper px-7 py-4 text-[17px] font-semibold leading-none text-red transition-colors duration-200 hover:bg-white lg:w-auto"
          >
            <WhatsAppMark />
            Ask us on WhatsApp
          </a>
